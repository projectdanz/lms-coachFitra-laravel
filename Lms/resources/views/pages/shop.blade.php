            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="rbt-default-card style-three rbt-hover">
                        <div class="inner">
                            <div class="content pt--0 pb--10">
                                <h2 class="title"><a href="{{ route('singleProduct') }}">Momentum Theorem</a></h2>

                                <span class="team-form">
                                    <span class="location">By John Due</span>
                                </span>
                            </div>
                            <div class="thumbnail"><a href="{{ route('singleProduct') }}"><img src="{{ asset('assets/images/product/4.jpg') }}" alt="Histudy Book Image"></a></div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="rbt-default-card style-three rbt-hover">
                        <div class="inner">
                            <div class="content pt--0 pb--10">
                                <h2 class="title"><a href="{{ route('singleProduct') }}">Happy Days</a></h2>

                                <span class="team-form">
                                    <span class="location">By John Due</span>
                                </span>
                            </div>
                            <div class="thumbnail"><a href="{{ route('singleProduct') }}"><img src="{{ asset('assets/images/product/8.jpg') }}" alt="Histudy Book Image"></a></div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="rbt-default-card style-three rbt-hover">
                        <div class="inner">
                            <div class="content pt--0 pb--10">
                                <h2 class="title"><a href="{{ route('singleProduct') }}">The Road</a></h2>

                                <span class="team-form">
                                    <span class="location">By John Due</span>
                                </span>
                            </div>
                            <div class="thumbnail"><a href="{{ route('singleProduct') }}"><img src="{{ asset('assets/images/product/6.jpg') }}" alt="Histudy Book Image"></a></div>
                            <div class="content">
