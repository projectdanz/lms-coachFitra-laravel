                            ...
                            <div class="inner">
                                ...
                                <ul class="rbt-sidebar-list-wrapper recent-post-list">
                                    <li>
                                        ...
                                        <div class="content">
                                            <h6 class="title"><a href="{{ route('eventDetails') }}">Elegant Light Box Paper Cut.</a></h6>
                                            <ul class="rbt-meta">
                                    ...
                                    <li>
                                        ...
                                        <div class="content">
                                            <h6 class="title"><a href="{{ route('eventDetails') }}">Most Effective Ways Education.</a></h6>
                                            <ul class="rbt-meta">
                                                <li><i class="feather-clock"></i>26 Mar, 2025</li>
                                            </ul>
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="content">
                                            <h6 class="title"><a href="{{ route('eventDetails') }}">Top 7 Common About Education.</a></h6>
                                            <ul class="rbt-meta">
