...
@section('content')
    ...
    <!-- Start Banner Area  -->
    <div class="slider-area rbt-banner-10 height-750 bg_image bg_image--11" data-black-overlay="1">
    </div>
    <!-- End Banner Area  -->
            ...
            <div class="row g-5 align-items-center">
                    ...
                    <div class="thumbnail-wrapper">
                        <div class="thumbnail image-1">
                            <img data-parallax='{"x": 0, "y": -20}'
                                src="{{ asset('assets/images/about/about-07.jpg') }}" alt="Education Images">
                        </div>
                        <div class="thumbnail image-2 d-none d-xl-block">
                            <img data-parallax='{"x": 0, "y": 60}' src="{{ asset('assets/images/about/about-09.jpg') }}"
                                alt="Education Images">
                        </div>
                        <div class="thumbnail image-3 d-none d-md-block">
                            <img data-parallax='{"x": 0, "y": 80}' src="{{ asset('assets/images/about/about-08.jpg') }}"
                                alt="Education Images">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="inner pl--50 pl_sm--0 pl_md--0">
                        ...
                        <p class="description mt--30">Sekolah Kaya adalah platform e-course dan mentoring bisnis yang
                            dirancang untuk membantu siapa saja—terutama kamu yang ingin punya bisnis sendiri atau ingin
                            mengembangkan bisnis lebih besar—dengan cara belajar yang praktis, intensif, dan menyenangkan!
                        </p>
                        <!-- Start Feature List  -->
                        <div class="rbt-feature-wrapper mt--40">
                            ...
                            <div class="rbt-feature feature-style-1">
                                ...
                                <div class="feature-content">
                                    <h6 class="feature-title">Sistem Poin & Tantangan Seru</h6>
                                    <p class="feature-description">Biar makin semangat, Sekolah Kaya pakai sistem
                                        game-based learning! <br> Kamu bisa kumpulkan poin, ikut kuis, dan berkompetisi
                                        sehat. Siapa cepat, dia dapat reward!</p>
                                </div>
                            </div>
                            ...
                            <div class="rbt-feature feature-style-1">
                                ...
                                <div class="feature-content">
                                    <h6 class="feature-title">Belajar via E-Course</h6>
                                    <p class="feature-description">Setiap kelas berisi video pembelajaran lengkap sesuai
                                        topik: Sales, Marketing, Branding, Leadership, Manajemen Keuangan, dan lainnya. Kamu
                                        tinggal pilih kelas, bayar sekali, lalu dapat akses penuh ke materi yang langsung
                                        bisa kamu pelajari dan terapkan di bisnismu.</p>
                                </div>
                            </div>
                            ...
                            <div class="rbt-feature feature-style-1">
                                ...
                                <div class="feature-content">
                                    <h6 class="feature-title">Bimbingan dari Coach Terpercaya</h6>
                                    <p class="feature-description">Semua materi disusun dan diajarkan oleh Coach Fitrah,
                                        mentor bisnis yang sudah membantu banyak bisnis naik level dan tumbuh besar.</p>
                                </div>
                            </div>
                        </div>
