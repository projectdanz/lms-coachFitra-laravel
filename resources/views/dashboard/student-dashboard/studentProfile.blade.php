                        ...
                        <div class="rbt-tutor-information">
                            <div class="rbt-tutor-information-left">
                                <div class="thumbnail rbt-avatars size-lg">
                                    <img src="{{ asset('assets/images/team/avatar-2.jpg') }}" alt="Instructor">
                                </div>
                                        ...
                                        <div class="rbt-default-sidebar-wrapper">
                                            ...
                                            <nav class="mainmenu-nav">
                                                <ul class="dashboard-mainmenu rbt-default-sidebar-list">
                                                    <li><a href="{{ route('studentDashboard') }}"><i class="feather-home"></i><span>Dashboard</span></a></li>
                                                    <li><a href="{{ route('studentProfile') }}"><i class="feather-user"></i><span>My Profile</span></a></li>
                                                    <li><a href="{{ route('studentEnrolledCourses') }}"><i class="feather-book-open"></i><span>Enrolled Courses</span></a></li>
                                                    <li><a href="{{ route('studentWishlist') }}"><i class="feather-bookmark"></i><span>Wishlist</span></a></li>
                                                    <li><a href="{{ route('studentReviews') }}"><i class="feather-star"></i><span>Reviews</span></a></li>
                                                    <li><a href="{{ route('studentMyQuizAttempts') }}"><i class="feather-help-circle"></i><span>My Quiz Attempts</span></a></li>
                                                    <li><a href="{{ route('studentOrderHistory') }}"><i class="feather-shopping-bag"></i><span>Order History</span></a></li>
                                                </ul>
                                            </nav>
                                            ...
                                            <nav class="mainmenu-nav">
                                                <ul class="dashboard-mainmenu rbt-default-sidebar-list">
                                                    <li><a href="{{ route('studentSettings') }}"><i class="feather-settings"></i><span>Settings</span></a></li>
